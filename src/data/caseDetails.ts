...
export const CASE_DETAILS: CaseDetailData[] = [
  {
    ...
    intro:
      'У Николая была впечатляющая история: бизнес, армейская служба, ошибки и потери, которые могли стать основой для личного бренда. Но соцсетей не существовало, не было ни позиционирования, ни понимания, что транслировать людям.',
    facts: [
      {
        title: 'Решение',
        items: [
    ...
    facts: [
      {
        ...
        items: [
          ...
          'Выстроил систему тем, сценариев, съёмок, Reels и публикаций',
    ...
    facts: [
      {
        ...
        items: [
          ...
          'С нуля разработали самостоятельный бренд «Лютик»',
          'Создали логотип, цветовую систему, шрифты и паттерны',
          'Подготовили систему для соцсетей, формы, мерча и полиграфии',
        ],
      },
      {
        title: 'Результат',
  ...
  },
  {
    id: 'park-estate',
    title: 'Park Estate',
    teaser: 'Не реклама квадратных метров, а история о жизни, частью которой предлагает стать Park Estate.',
    intro:
    ...
    facts: [
      ...
      {
        title: 'Результат',
        items: ['Получилась маленькая история о мире, частью которого предлагает стать Park Estate'],
      },
    ],
    layout: 'horizontal',
  ...
  },
  {
    ...
    intro:
      'Съёмка рекламной кампании Rolf Oil проходила в Турции. Я работал внутри продакшна и отвечал за backstage-съёмку проекта.',
    facts: [
      {
        title: 'Подход',
        items: [
  ...
  },
  {
    ...
    intro:
      '23 августа 2023 года останется здесь. Красочная история со дня рождения известного блогера Сергея Косенко в Бодруме, снятая в формате живого влога.',
    facts: [
      {
        title: 'Задача',
        items: [
